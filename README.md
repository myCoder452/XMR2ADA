...
I was able to completely update the code and merge the two GUIs, this took notable adjustments and also implementing some creativity. So now both the XMR and the ADA sections functionalities are displayed on one screen, being able to engage with both networks simultaneously is a paramount feature for this project. 
